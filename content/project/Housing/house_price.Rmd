...
```{r saleprice_hist, message=FALSE, warning=FALSE, fig.align='center', out.width= "60%"}
...
```{r saleprice1, message=FALSE, fig.align='center',out.width= "60%"}
...
```{r correlation, fig.align='center', out.width="150%"}
